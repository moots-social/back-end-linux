    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http.headers(frameOption -> frameOption.disable())
                ...
                .authorizeHttpRequests(athz -> athz
                        ...
                        .requestMatchers(HttpMethod.GET, "/report/{id}").hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/report/deletar/{id}").hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/report/post/{postId}").hasAnyRole("ADMIN")
